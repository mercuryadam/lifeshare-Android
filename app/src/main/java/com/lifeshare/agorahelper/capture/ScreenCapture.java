package com.lifeshare.agorahelper.capture;
...
import com.lifeshare.agorahelper.GlUtil;
import com.lifeshare.agorahelper.ImgTexFormat;
import com.lifeshare.agorahelper.ImgTexFrame;
import com.lifeshare.agorahelper.SrcConnector;
...
public class ScreenCapture implements SurfaceTexture.OnFrameAvailableListener {
    ...
    private void doScreenSetup() {
        ...
        Intent intent;
        (intent = new Intent(mContext, ScreenCaptureAssistantActivity.class)).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
